...
function get_soft() {
	...
	for (var i = 0; i < data.length; i++) {
		...
		if(i<4)
		{
			//str1 += '<li style="width:50%;"><p class="soft-icon"><a href="javascript:;"><img style="border:none;border-radius:0;width:80%;" src="'+new_static_url+'/activity/March_pin_2017/images/banner'+i+'.png"/></a></p><p class="soft-name"><a href="javascript:;">' + softname + '</a></p><p>' + my_soft + '</p></li>';
			str1 += '<li><p class="soft-icon"><a href="javascript:;"><img src="'+new_static_url+'/activity/March_pin_2017/images/app_icon_'+i+'.png"/></a></p><p class="soft-name"><a href="javascript:;">' + softname + '</a></p><p>' + my_soft + '</p></li>';
		}
		else
		{
...
function download_go(pkgname,softid) {
	$.ajax({
		url:'/lottery/March_pin_2017/lottery_download.php?aid='+aid+'&sid='+sid,
