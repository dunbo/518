...
$login_url = $center_url.$activity_host."/lottery/{$prefix}/index_2017.php?".$build_query;
...
$where = array(
	'status' => 1,
	'aid' => $aid,
	'pid' => array('exp', "not in (336,337,344,345,352,353)")
);
...
if($_GET['stop'] == 1){
	$tpl = "lottery/{$prefix}/end_2017.html";
}else{
	//指定用户中奖
	add_test_user_award();
	$tpl = "lottery/{$prefix}/index_2017.html";
}
