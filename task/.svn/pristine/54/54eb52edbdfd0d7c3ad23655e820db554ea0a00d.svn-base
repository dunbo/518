...
/*
   11月回归安智100%有礼 派现金红包活动 db处理 worker
*/
...
$worker->addFunction("flyback_db", "handle");
while ($worker->work());
