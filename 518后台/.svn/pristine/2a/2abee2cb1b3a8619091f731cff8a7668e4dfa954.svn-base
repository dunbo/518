...
K.options = {
	...
	items : [
		...
		'anchor', 'link', 'unlink', '|', 'about','aziframe'
	],
...
_plugin('core', function(K) {
	...
	self.plugin.getSelectedAziframe = function() {
		return _getImageFromRange(self.edit.cmd.range, function(img) {
			return img[0].className == 'ke-aziframe';
		});
	};
...
KindEditor.lang({
	...
	editMedia : '视音频属性',
	deleteMedia : '删除视音频',
	editAziframe : 'iframe属性',
	deleteAziframe : '删除iframe',
	editLink : '超级链接属性',
	deleteLink : '取消超级链接',
	editAnchor : '锚点属性',
	deleteAnchor : '删除锚点',
	...
	self.plugin.media = {
		edit : function() {
			var html = [
				...
				'<div class="ke-dialog-row">',
				'<label for="keUrl" style="width:60px;">上传视频</label>',
				'<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
				'<input type="button" class="ke-upload-button" value="' + lang.upload + '" /> &nbsp;',
				...
				'<div class="ke-dialog-row">',
				'<label for="keUrl" style="width:60px;">视频默认图</label>',
				'<input class="ke-input-text" type="text" id="imgurl" name="imgurl" value="" style="width:160px;" /> &nbsp;',
				'<input type="button" class="ke-upload-button2" value="' + lang.upload + '" /> &nbsp;',
...
*/
			...
			if (allowMediaUpload) {
				var uploadbutton2 = K.uploadbutton({
					button : K('.ke-upload-button2', div)[0],
					fieldName : filePostName,
					extraParams : extraParams,
