...
$fix_package = '["com.qq.ac.android","com.cfzq.lezhuan","com.netease.yanxuan","com.lcworld.oasismedical"]';
...
$rkey_imsi_lottery_num = "double11_pin_2016:{$aid}:{$imsi}:rest_lottery_num";//用户可抽奖次数
$rkey_imsi_package_list = "double11_pin_2016:{$aid}:{$imsi}:package_list"; //下载的包
