...
{
?>
				<a href="javascript:void(0)" class="btns_03" onclick="window.open('taobaowebview://m.taobao.com/?weburl=http://m.taobao.com/channel/act/mobile/20131111-main.html?ttid=2236l006&actparam=1_38902_qd0006_anzhipush').location.href='notes_02.php';sleep(600)" ></a>
<?php
}
else
{
?>
				<a href="taobaowebview://m.taobao.com/?weburl=http://m.taobao.com/channel/act/mobile/20131111-main.html?ttid=2236l006&actparam=1_38902_qd0006_anzhipush" class="btns_03" onclick="sleep(600)" ></a>
<?php
}
?>
			</div>
...
<script>
	function sleep(msec){
		//alert(msec);
		timer=setTimeout("jump('<?php if (empty($sid)) echo 'notes_02.php'; else echo "notes_02.php?sid=$sid";?>')", msec);
	}
