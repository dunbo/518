...
$login_url = $center_url."http://promotion.anzhi.com/lottery/ask/index.php?".$build_query;
...
if(isset($_SESSION['USER_UID']) && $_SESSION['USER_ID'] != 13176){//已登录
	...
	$kind_award_list = get_user_kind_award_new($uid,$active_id,'ask','valentine_draw_award');//获取该用户实物
	$kind_award_gift = get_user_kind_gift_new($uid,$active_id,"ask","valentine_draw_gift");//获取该用户礼包
...
$tplObj -> out['award_all'] = get_award_all_new($active_id,"ask",'valentine_draw_award');//获取获奖人信息奖品
if($_GET['stop'] == 1){
	$tpl = "lottery/ask/end.html";
}else{
	$tpl = "lottery/ask/index.html";
}
