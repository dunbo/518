...
$(function() {
	var arr1 = [{
		pos : "0,1.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery1.png',
		title : '华为note8'
	},{
		pos : "5.8rem,1.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery2.png',
		title : '华为mate s'
	},{
		pos : "11.6rem,1.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery3.png',
		title : 'Beats耳机'
	},{
		pos : "0,8rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery4.png',
		title : '500元京东卡'
	},{
		pos : "11.6rem,8rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery5.png',
		title : '电影网年卡'
	},{
		pos : "0rem,14.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery6.png',
		title : '优酷路由宝'
	},{
		pos : "5.8rem,14.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery7.png',
		title : '100元京东卡'
	},{
		pos : "11.6rem,14.5rem,0",
		url : new_static_url+'/activity/double11_pin_2016/images/lottery0.png',
		title : ''
	}]
	arr = arr1;
	my_soft();
...
function get_soft() {
	...
	for (var i = 0; i < data.length; i++) {
		...
		if(i<4)
		{
			//str1 += '<li style="width:50%;"><p class="soft-icon"><a href="javascript:;"><img style="border:none;border-radius:0;width:80%;" src="'+new_static_url+'/activity/double11_pin_2016/images/banner'+i+'.png"/></a></p><p class="soft-name"><a href="javascript:;">' + softname + '</a></p><p>' + my_soft + '</p></li>';
			str1 += '<li><p class="soft-icon"><a href="javascript:;"><img src="'+new_static_url+'/activity/double11_pin_2016/images/app_icon_'+i+'.png"/></a></p><p class="soft-name"><a href="javascript:;">' + softname + '</a></p><p>' + my_soft + '</p></li>';
		}
		else
		{
...
function download_go(pkgname,softid) {
	$.ajax({
		url:'/lottery/double11_pin_2016/lottery_download.php?aid='+aid+'&sid='+sid,
