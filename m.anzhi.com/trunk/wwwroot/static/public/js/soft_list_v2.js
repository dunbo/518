...
function get_soft_li(aid,sid,soft_status,softid,my_package,softname,versioncode,size,src){
	if(soft_status == 1){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 2 || soft_status == 3 || soft_status == 8){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 4){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 5){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 6){
		var soft_li = '<li id="li_'+softid+'" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" ><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 9){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon<img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
	}else if(soft_status == 10){
		var soft_li = '<li><p class="soft_icon"><img src="'+src+'"/></p><p class="soft_name">'+softname+'</p></li>';
...
function get_soft_li_l(aid,sid,soft_status,softid,my_package,softname,versioncode,size,src){
	if(soft_status == 1){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn"><a href="javacript:;" class="soft_btn" >下载中</a></p></li>';
	}else if(soft_status == 2 || soft_status == 3 || soft_status == 8){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a id="'+softid+'" href="javacript:;" class="soft_btn" >继续</a></p></li>';
	}else if(soft_status == 4){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a id="'+softid+'" href="javacript:;" class="soft_btn" >下载</a></p></li>';
	}else if(soft_status == 5){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn"><a href="javacript:;" id="'+softid+'" class="soft_btn" >安装</a></p></li>';
	}else if(soft_status == 6){
		var soft_li = '<li id="li_'+softid+'" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a href="javacript:;" class="soft_btn soft_open" >打开</a></p></li>';
	}else if(soft_status == 9){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a href="javacript:;" class="soft_btn" >校验中</a></p></li>';
	}else if(soft_status == 10){
		var soft_li = '<li><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a id="'+softid+'" href="javacript:;" class="soft_btn" >已下载</a></p></li>';
	}else if(soft_status == -1){
		var soft_other_status = window.AnzhiActivitys.isInstalledApp(my_package,parseInt(versioncode));
		if(soft_other_status == -2){
			var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a id="'+softid+'" href="javacript:;" class="soft_btn" >下载</a></p></li>';
		}else if(soft_other_status == -1){
			var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a id="'+softid+'" href="javacript:;" class="soft_btn" >更新</a></p></li>';
		}else if(soft_other_status == 0){
			var soft_li = '<li id="li_'+softid+'" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" ><p class="soft_icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn" ><a href="javacript:;" class="soft_btn soft_open" >打开</a></p></li>';
		}else if(soft_other_status == 1){
			var soft_li = '<li ><p class="soft_icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p class="btn"><a id="'+softid+'" href="javacript:;" class="soft_btn" >已下载</a></p></li>';
			//var soft_li = '<li onclick="openApp(\''+my_package+'\','+softid+')" ><p class="soft_icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name">'+softname+'</p><p><a href="javacript:;" class="soft_btn" >打开</a></p></li>';
		}
	}
	return soft_li;
}
