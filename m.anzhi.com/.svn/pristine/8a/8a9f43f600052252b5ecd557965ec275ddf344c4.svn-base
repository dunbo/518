...
{
?>
				<a href="javascript:void(0)" class="btns_01" onclick="window.open('taobaowebview://m.taobao.com/?weburl=http://m.taobao.com/channel/act/315/anzhi1111.xhtml').location.href='notes_01_t.php';sleep(600)" ></a>
<?php
}
else
{
?>
				<a href="taobaowebview://m.taobao.com/?weburl=http://m.taobao.com/channel/act/315/anzhi1111.xhtml" class="btns_01" onclick="sleep(600)" ></a>
<?php
}
?>
			</div>
...
<script>
	function sleep(msec){
		//alert(msec);
		timer=setTimeout("jump('<?php if (empty($sid)) echo 'notes_01_t.php'; else echo "notes_01_t.php?sid=$sid";?>')", msec);
	}
