...
class tlauncher{
	...
	public function getData(){
		...
		$option = array(
			...
			'field' => 'b.softid, b.softname, a.package, icon_url',
	...
	protected function get_data_xml($infos,$channel,$api,$server){
		...
		foreach($infos as $info){
			if($info['package']){
				...
				$data_str .= "</apksize>";
				$data_str .= "<desc>";
				$data_str .= "<![CDATA[{$info['intro']}]]>";
				$data_str .= "</desc>";
				$data_str .= "<downloads>";
				$data_str .= $info['downloaded'];
				$data_str .= "</downloads>";
				$data_str .= "<score>";
				$data_str .= $info['score'];
				$data_str .= "</score>";
