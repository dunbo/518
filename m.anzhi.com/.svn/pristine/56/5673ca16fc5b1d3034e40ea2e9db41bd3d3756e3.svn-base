...
function get_soft() {
	...
	for (var i = 0; i < data.length; i++) {
		...
		str += '<li><p class="soft_icon"><a href="javascript:;"><img src="' + icon_url + '"/></a></p><p class="soft_name"><a href="javascript:;">' + short_softname + '</a></p><p>' + my_soft + '</p></li>';
...
function download_go(pkgname,softid) {
	$.ajax({
		url:'/lottery/RioOlympicGames/lottery_download.php?aid='+aid+'&sid='+sid,
