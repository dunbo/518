...
$login_url = $center_url."http://promotion.anzhi.com/lottery/my_name_MT3_new/index.php?".$build_query;
...
if((isset($_SESSION['USER_UID']) && $_SESSION['USER_ID'] != 13176)||($_SESSION['USER_IMSI'] ==''&&$cook_is_jump==1))//已登录
{
...
$tpl = "lottery/my_name_MT3_new/index.html";
if($_SERVER['SERVER_ADDR'] == '118.26.203.23')
{
