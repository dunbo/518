...
(function(){
	...
	document.writeln(".anzhi_ft_close a{display:inline-block; background:url(http://img3.anzhi.com/img/201601/19/close_menu_logo.png) no-repeat 0 0px;width:20px; height:20px; cursor:pointer;}");
	document.writeln("<\/style>");
