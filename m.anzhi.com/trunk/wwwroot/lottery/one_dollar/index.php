...
$login_url = $center_url."http://promotion.anzhi.com/lottery/one_dollar/index.php?".$build_query;
...
if($_GET['stop'] == 1){
	...
	if((strtotime("2015-09-23 22:00:00")+(5*86400)) <= $time){
		$tplObj -> out['is_stop15'] = 1;	//活动结束完5天
	}
	$tpl = "lottery/one_dollar/index_end.html";
}else{
	//奖品
	$prize_info = array();
	for ($i = 1; $i <= 4; $i++) {
	...
	$tpl = "lottery/one_dollar/index.html";
}
