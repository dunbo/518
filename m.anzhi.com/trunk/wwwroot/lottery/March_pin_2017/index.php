...
$tplObj-> out['share_text'] ="春天来了浪里个浪，现在来@安智市场 参加活动超多好奖等你拿真的很棒棒哦，快来和我一起造作吧~";
if ($now > $activity_end_time) {
	$tplObj->display('lottery/March_pin_2017/end.html');
}
else{
	$tplObj->display('lottery/March_pin_2017/index.html');
}
exit;