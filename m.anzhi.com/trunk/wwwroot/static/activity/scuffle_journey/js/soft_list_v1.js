...
function get_soft_li_l(aid,sid,soft_status,softid,my_package,softname,versioncode,size,src){
	if(soft_status == 1){
		var soft_li = '<li id="li_'+softid+'" ><p class="soft-icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn"><a  onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" href="javascript:;" class="downlode" >下载中</a></p></li>';
	}else if(soft_status == 2 || soft_status == 3 || soft_status == 8){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" id="'+softid+'" href="javascript:;" class="downlode" >继续</a></p></li>';
	}else if(soft_status == 4){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" id="'+softid+'" href="javascript:;" class="downlode" >下载</a></p></li>';
	}else if(soft_status == 5){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn"><a onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" href="javascript:;" id="'+softid+'" class="downlode" >安装</a></p></li>';
	}else if(soft_status == 6){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" href="javascript:;" class="downlode" >打开</a></p></li>';
	}else if(soft_status == 9){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" href="javascript:;" class="downlode" >校验中</a></p></li>';
	}else if(soft_status == 10){
		...
		if(soft_other_status == -2){
			...
			var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" id="'+softid+'" href="javascript:;" class="downlode" >更新</a></p></li>';
		}else if(soft_other_status == 0){
			var soft_li = '<li id="li_'+softid+'"  ><p class="soft-icon"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn" ><a onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" href="javascript:;" class="downlode" >打开</a></p></li>';
		}else if(soft_other_status == 1){
			var soft_li = '<li ><p class="soft-icon"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft-name">'+softname+'</p><p class="btn"><a id="'+softid+'" href="javascript:;" class="downlode" >已下载</a></p></li>';
...
function go_softinfo_down2(softid,my_package,softname,versioncode,size,aid,sid,details){
	$.ajax({
