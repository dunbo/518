...
$activity_option = array(
    'where' => array(
        'config_type' => 'CHRISTMAS2015_LOTTERY_AWARD',
        'status' => 1
    ),
    'cache_time' => 1200,
    'table' => 'pu_config'
...
$each_day_award = array(
	'20151216' => array(100,100,100,100,100,100,100),
	'20151217' => array(0,0,0,0,0,0,0),
	'20151218' => array(0,0,0,0,0,0,0),
	'20151219' => array(0,0,0,0,0,0,0),
	'20151220' => array(0,0,0,0,0,0,0),
	'20151221' => array(0,0,0,0,0,0,0),
	'20151222' => array(0,0,0,0,0,0,0),
	'20151223' => array(0,0,0,0,0,0,0),
	'20151224' => array(0,0,0,0,0,0,0),
	'20151225' => array(0,0,0,0,0,0,0),
	'20151226' => array(0,0,0,0,0,0,0),
	'20151227' => array(0,0,0,0,0,0,0),
);
/*
// 线上的中奖概率
$each_day_award = array(
	'20151215' => array(0,0,0,0,0,0,0),
	'20151216' => array(0,0,0,0,0,0,0),
	'20151217' => array(0,0,0,0,0,0,0),
	'20151218' => array(0,0,0,0,0,0,0),
	'20151219' => array(0,0,0,0,0,0,0),
	'20151220' => array(0,0,0,0,0,0,0),
	'20151221' => array(0,0,0,0,0,0,0),
	'20151222' => array(0,0,0,0,0,0,0),
	'20151223' => array(1,1,0,0,6,4,3000),
	'20151224' => array(0,1,0,0,4,3,1000),
	'20151225' => array(0,0,1,1,4,3,1000),
	'20151226' => array(0,0,0,0,8,5,2500),
	'20151227' => array(0,0,0,0,8,5,2500),
);
*/
// 算出下一天累计奖品总数
$the_time = array();
...
$worker->addFunction("christmas2015_lottery", "get_num");
while ($worker->work());
...
function get_num($jobs) {
	...
	// 截止今天剩余奖品个数缓存
	$rkey_today_award_left = "christmas2015:{$active_id}:{$now}:award_left";
	...
	$gift_table = !empty($package) ? 'christmas2015_gift_list' : 'christmas2015_gift_list_common';
	if ($award_type == 2) {
		// 中的是礼包，判断此用户之前是否中过此奖，如果中过，则返回没中奖
		$rkey_user_gift_win = "christmas2015:{$active_id}:giftwin:{$imsi}:{$award_level}";
	...
	$data = array(
		...
		'time' => time(),
		'status' => $status,
		'__user_table' => 'christmas2015_lottery_award',
	);
