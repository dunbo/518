...
{
?>
				<a href="javascript:void(0)" class="btns_01" onclick="alert(window.open('taobaowebview://m.taobao.com/?weburl=http://m.taobao.com').location.href='http://www.baidu.com');sleep(600)" ></a>
<?php
}
else
{
?>
				<a href="javascript:void(0)" class="btns_01" onclick="window.AnzhiActivitys.openAppForActivity('com.taobao.taobao');sleep(600)" ></a>
<?php
}
?>
			</div>
