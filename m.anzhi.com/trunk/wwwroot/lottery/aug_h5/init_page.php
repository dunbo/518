...
// 		//ios
// 		$tplObj->display("lottery/{$prefix}/ios.html");exit;
// 	}elseif ( strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger') !== false ) {
// 		//微信
// 		$tplObj->display("lottery/{$prefix}/weixin.html");exit;
// 	}else {
// 		//普通浏览器
// 		$tplObj->display("lottery/{$prefix}/down.html");exit;
// 	}
// }
...
if ($_SESSION['VERSION_CODE'] && $_SESSION['VERSION_CODE'] < 6400) {
...
// 	permanentlog($activity_log_file, json_encode($log_data));
	// 跳转到提示升级页面
	$tplObj->display("lottery/{$prefix}/update_hint.html");
	exit;
}

if( $_SESSION['VERSION_CODE'] && (!$imsi || ($imsi && strlen($imsi) == 15 && $imsi == '000000000000000')) ) {
	// 	$log_data = array(
	// 			'imsi'			=>	$_SESSION['USER_IMSI'],
	// 			'device_id'		=>	$_SESSION['DEVICEID'],
	// 			'activity_id'	=>	$aid,
	...
	// 	permanentlog($activity_log_file, json_encode($log_data));
	// 跳转到提示页面
	$tplObj->display("lottery/{$prefix}/page_expired_hint.html");
	exit;
}