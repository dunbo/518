...
// 加载活动相关信息（活动固定软件）
$fix_package = '["com.jscf.js_app","com.achievo.vipshop","com.qq.ac.android"]';
...
$rkey_imsi_puzzle = "christmas_pin_2016:{$aid}:{$imsi}:".$date;//用户每天拼图次数
$rkey_imsi_lottery_num = "christmas_pin_2016:{$aid}:{$imsi}:rest_lottery_num";//用户可抽奖次数
$rkey_imsi_package_list = "christmas_pin_2016:{$aid}:{$imsi}:package_list"; //下载的包
$rkey_imsi_pics_list = "christmas_pin_2016:{$aid}:{$imsi}:pics_list"; //图片
