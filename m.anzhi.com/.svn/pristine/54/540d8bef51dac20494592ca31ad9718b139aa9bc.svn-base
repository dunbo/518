...
if($_GET['stop'] != 1 ) {
	...
	if(!$res) {
		$url = $activity_host."/lottery/{$prefix}/index_2017.php?stop=1&aid=".$active_id;
		header("Location: {$url}");
	}
}
/**
...
//抽奖
function lottery_do($uid,$from_type){
	global $active_id;	
	global $prefix;	
	load_helper('task');
	$position = array(
	...
	if(empty($prize_user_config)){
		$prize_user_config = array(
			'20151222164540x50cMae6Mx' => array(
				'start_tm' => strtotime("2016-12-31 03:08:00"),
				'end_tm' => strtotime("2016-12-31 12:45:00"),
				'username' => 'az84607163',
				'is_award' => 0,
				'level' => 11,
			),
			'20131015143305u7C9xiLe1L' => array(
				'start_tm' => strtotime("2016-12-31 12:49:00"),
				'end_tm' => strtotime("2016-12-31 23:00:00"),
				'username' => 'aztt13716490',
				'is_award' => 0,
				'level' => 11,			
			),
			'201411121551270uP6zqbTRP' => array(
				'start_tm' => strtotime("2016-12-31 23:05:00"),
				'end_tm' => strtotime("2017-01-01 02:25:00"),
				'username' => 'azjxyz110',
				'is_award' => 0,
				'level' => 11,				
			),
			'20161027154025252EajojB9' => array(
				'start_tm' => strtotime("2017-01-01 02:33:00"),
				'end_tm' => strtotime("2017-01-01 12:00:00"),
				'username' => 'az132312049',
				'is_award' => 0,
				'level' => 11,			
			),
			'20160331103802I0wxhvMapI' => array(
				'start_tm' => strtotime("2017-01-01 12:03:00"),
				'end_tm' => strtotime("2017-01-01 16:10:00"),
				'username' => 'az100681553',
				'is_award' => 0,
				'level' => 11,				
			),
			'20160623205302pj8SFz1e8g' => array(
				'start_tm' => strtotime("2017-01-01 16:14:00"),
				'end_tm' => strtotime("2017-01-01 20:00:00"),
				'username' => 'az114224977',
				'is_award' => 0,
				'level' => 11,				
			),
			'201504281832037Dr9487aSz' => array(
				'start_tm' => strtotime("2017-01-01 20:01:00"),
				'end_tm' => strtotime("2017-01-02 16:10:00"),
				'username' => 'az53484482',
				'is_award' => 0,
				'level' => 11,				
			),
			'20141106140906i2ouEtLdou' => array(
				'start_tm' => strtotime("2017-01-02 16:20:00"),
				'end_tm' => strtotime("2017-01-02 23:50:00"),
				'username' => 'az30282450',
				'is_award' => 0,
				'level' => 11,				
			),
			'20161027155333n99rzw5GHs' => array(
				'start_tm' => strtotime("2016-12-31 22:36:00"),
				'end_tm' => strtotime("2017-01-01 11:09:00"),
				'username' => 'BO7452188',
				'is_award' => 0,
				'level' => 21,				
			),		
			'20161027155710A2MHey2QGu' => array(
				'start_tm' => strtotime("2017-01-01 11:10:00"),
				'end_tm' => strtotime("2017-01-02 09:10:00"),
				'username' => 'liangli04',
				'is_award' => 0,
				'level' => 21,				
			),			
			'20161027155851M4b749c8tu' => array(
				'start_tm' => strtotime("2017-01-02 09:17:00"),
				'end_tm' => strtotime("2017-01-02 14:15:00"),
				'username' => 'ab7756ri',
				'is_award' => 0,
				'level' => 21,				
			),			
			'20161027154825739rz2K1iP' => array(
				'start_tm' => strtotime("2017-01-02 14:20:00"),
				'end_tm' => strtotime("2017-01-02 23:55:00"),
