...
function get_soft_li(aid,sid,soft_status,softid,my_package,softname,versioncode,size,src){
	if(soft_status == 1){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 2 || soft_status == 3 || soft_status == 8){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 4){
		var soft_li = '<li id="li_'+softid+'" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" ><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 5){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 6){
		var soft_li = '<li id="li_'+softid+'" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" ><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 9){
		var soft_li = '<li id="li_'+softid+'" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" ><p class="soft_icon clear<img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
	}else if(soft_status == 10){
		var soft_li = '<li><p class="soft_icon clear"><img src="'+src+'"/></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p></li>';
...
function get_soft_li_l(aid,sid,soft_status,softid,my_package,softname,versioncode,size,src){
	if(soft_status == 1){
		var soft_li = '<li id="li_'+softid+'"><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p ><a href="javascript:;" class="download btns" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" >下载中</a></p></li>';
	}else if(soft_status == 2 || soft_status == 3 || soft_status == 8){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a id="'+softid+'" href="javascript:;" class="download btns" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" >继续</a></p></li>';
	}else if(soft_status == 4){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a id="'+softid+'" href="javascript:;" class="download btns" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" >下载</a></p></li>';
	}else if(soft_status == 5){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p ><a href="javascript:;" id="'+softid+'" class="download btns" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')" >安装</a></p></li>';
	}else if(soft_status == 6){
		var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a href="javascript:;" class="download btns" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" >打开</a></p></li>';
	}else if(soft_status == 9){
		var soft_li = '<li id="li_'+softid+'" ><p class="soft_icon clear"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a href="javascript:;" class="download btns" onclick="installApp('+softid+',\''+my_package+'\','+aid+',\''+sid+'\')"  >校验中</a></p></li>';
	}else if(soft_status == 10){
		var soft_li = '<li><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a id="'+softid+'" href="javascript:;" class="download btns" >已下载</a></p></li>';
	}else if(soft_status == -1){
		var soft_other_status = window.AnzhiActivitys.isInstalledApp(my_package,parseInt(versioncode));
		if(soft_other_status == -2){
			var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a id="'+softid+'" href="javascript:;" class="download btns" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" >下载</a></p></li>';
		}else if(soft_other_status == -1){
			var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a id="'+softid+'" href="javascript:;" class="download btns" onclick="go_softinfo_down('+softid+',\''+my_package+'\',\''+softname+'\','+versioncode+','+size+','+aid+',\''+sid+'\')" >更新</a></p></li>';
		}else if(soft_other_status == 0){
			var soft_li = '<li id="li_'+softid+'"  ><p class="soft_icon clear"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p  ><a href="javascript:;" class="download btns" onclick="openApp(\''+my_package+'\','+softid+','+aid+',\''+sid+'\')" >打开</a></p></li>';
		}else if(soft_other_status == 1){
			var soft_li = '<li ><p class="soft_icon clear"><a href="javascript:;"><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p ><a id="'+softid+'" href="javascript:;" class="download btns" >已下载</a></p></li>';
			//var soft_li = '<li onclick="openApp(\''+my_package+'\','+softid+')" ><p class="soft_icon clear"><a href="javascript:;" ><img src="'+src+'"/></a></p><p class="soft_name"><a  href="javascript:;">'+softname+'</a></p><p><a href="javascript:;" class="download btns" >打开</a></p></li>';
		}
	}
	return soft_li;
}
...
function onDownloadStateChanged(softid,newState){
	...
	if(newState == 1){
		...
		for(i=0;i < soft_lists_go.length;i++){		
			if(soft_lists_go[i][0] == softid){
				$('#'+softid).attr('onclick',"openApp('"+soft_lists_go[i][7]+"',"+parseInt(softid)+","+parseInt(aid)+",'"+sid+"')");
			}
		}
