...
$tplObj -> out['tpl_prefix']			=	$tpl_prefix;
...
$tplObj -> out['title']					=	'开宝箱赢大奖  iPhoneX天天送';
$tplObj -> out['share_text']			=	'免费开宝箱活动已经开启，赶快来参与吧！';
...
function azb_consume($uid, $pwd, $azbAmount){
	...
	$res = consume_azb($active_id, $uid, $pwd, $azbAmount, '18年3月开宝箱');
	//支付结果日志
	$log_data = array(
		"imsi"			=>	$_SESSION['USER_IMSI'],
		"device_id"		=>	$_SESSION['DEVICEID'],
